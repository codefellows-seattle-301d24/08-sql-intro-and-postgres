...
app.get('/new', function(request, response) {
  ...
  // the following line relates to number 5 in the full-stack-diagram.png, it relates to the toHtml function, this relates to the r in crud.
...
app.get('/articles', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // This corresponds to numbers 3, 4, and 5 in the diagram, this relates to the fetch all method in article.js, this relates to the r in crud
...
app.post('/articles', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 3,4, and 5 of the diagram, this has to do with the insertRecord function, this is the c in crud, create.
...
app.put('/articles/:id', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here... 3, 4, 5 of the diagram, corresponds with the update record function, u of crud, update.
...
function loadArticles() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // C in CRUD, 3 and 4 in the full stack diagram, doesn't related to anything in artcle.js. It only has to do with the backend.
...
function loadDB() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 3 and 4, relates to C in CRUD, doesn't relate to article.js
  client.query(`
