...
const conString = process.env.DATABASEURL || 'postgres://postgres:54321@localhost:5432/kilovolt';
...
app.get('/new', function(request, response) {
  ...
  // Put your response here... CRUD part in this is READ
...
app.post('/articles', function(request, response) {
  ...
  // 4, 5, Article.prototype.insertRecord
...
app.put('/articles/:id', function(request, response) {
  ...
  // 2, 3, Article.prototype.insertRecord
...
// Creting a table in the database if one doesn't exist, if it does exist it pulls the data down.Calling the database function inside of the AJAX call
